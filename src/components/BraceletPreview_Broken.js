      ...
      <div style={{ textAlign: 'center' }}>
        <div className="bc-bracelet-preview-container">
          <div className="bc-product-canvas">
            {/* Wrap the entire overlapping area with FreeDropArea during charm step */}
            {((isStandardMode && currentStep === 3) || (isNoWordsMode && currentStep === 2)) && !isReviewMode ? (
              ...
              {/* Free placed charms - interactive in charm step, static otherwise */}
              {((isStandardMode && currentStep === 3) || (isNoWordsMode && currentStep === 2)) && !isReviewMode ? (
            ...
            {/* Close the conditional FreeDropArea or regular div */}
            {((isStandardMode && currentStep === 3) || (isNoWordsMode && currentStep === 2)) && !isReviewMode ? 
              null : null}
          </div>
